...
const AppSidebar = () => {
  ...
  return (
    <nav aria-label="Sidebar navigation" className="shrink-0">
      ...
      <div className="md:hidden">
        <Sheet open={open} onOpenChange={setOpen}>
          <SheetTrigger asChild>
            <button
              type="button"
              className="inline-flex items-center gap-2 rounded-md border bg-white px-3 py-2 text-sm font-medium text-[#414141] shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
