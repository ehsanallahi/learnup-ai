...
const Navbar = () => {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 bg-[#f7f8fa] shadow">
      <nav className="h-14 md:h-16 px-4 md:px-6">
        <div className="mx-auto flex h-full w-full max-w-7xl items-center justify-between">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            ...
            <button
              type="button"
              className="inline-flex items-center justify-center rounded-md p-2 text-[#414141] hover:bg-white/60 focus:outline-none focus:ring-2 focus:ring-blue-500 lg:hidden"
            ...
            <div className="hidden lg:flex items-center">
              <NavigationMenu>
                <NavigationMenuList className="space-x-6 xl:space-x-7">
                  {/* Teams */}
                  <NavigationMenuItem>
                    <Link
                      href="/"
                      className="flex items-center gap-2 px-2 xl:px-4 py-2 text-sm font-medium text-blue-600 hover:text-blue-800"
                    >
                      ...
                      <span className="text-[#414141] font-semibold font-sora text-sm xl:text-[16px]">Teams</span>
                    </Link>
                  </NavigationMenuItem>
                  ...
                  <NavigationMenuItem>
                    ...
                    >
                      ...
                      <span className="text-[#414141] font-semibold font-sora text-sm xl:text-[16px]">Users</span>
                    </Link>
                  </NavigationMenuItem>

                  {/* Org Name & Members */}
                  <div className="flex flex-col pl-6 xl:pl-10 space-y-1.5">
                    <Link href="/" className="font-bold text-[#1F1F1F] text-base xl:text-[18px] font-sora">
                      Organization Name
                    </Link>
                    <div className="flex">
          ...
          {/* Right: Avatar + Name (hide name on small screens) */}
          <div className="flex items-center gap-3 md:gap-4">
            <DropdownMenu>
              <DropdownMenuTrigger className="focus:outline-none">
                <Avatar className="w-10 h-10 md:w-14 md:h-14 bg-transparent">
            ...
            <div className="hidden md:flex flex-col">
              <Link className="text-sm md:text-base font-semibold text-[#414141] font-sora" href="/">
                Name Surname
              </Link>
              <Badge variant="secondary" className="bg-[#7695ff] text-[10px] md:text-xs text-[#F7F8FA] dark:bg-blue-600 font-roboto w-fit">
                Super Admin
              </Badge>
            </div>
          </div>
      ...
      <div
        ...
        } overflow-hidden bg-[#f7f8fa] border-t border-black/5`}
      >
        <div className="px-4 py-3 space-y-2">
          <Link
            href="/"
            className="flex items-center gap-2 rounded-md px-3 py-2 text-sm font-medium text-blue-600 hover:bg-white"
          ...
          >
            ...
            <span className="text-[#414141] font-semibold font-sora text-sm">Teams</span>
          </Link>
          ...
          >
            ...
            <span className="text-[#414141] font-semibold font-sora text-sm">Users</span>
          </Link>

          <div className="rounded-md px-3 py-2">
            <Link href="/" className="font-bold text-[#1F1F1F] text-sm font-sora">
              Organization Name
            </Link>
            <div className="mt-1 flex text-xs">
              <div className="text-[#414141] font-roboto">Members:</div>
              <div className="text-[#083DF5] font-roboto ml-1">100</div>
            </div>
          </div>

          {/* Optional: show name/badge on mobile under menu */}
          <div className="border-t border-black/5 pt-3 mt-2 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Avatar className="w-8 h-8 bg-transparent">
                <AvatarFallback className="p-0 w-full h-full bg-transparent">
                  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 61 61" fill="none" className="rounded-full object-cover">
                    <circle cx="30.5" cy="30.5" r="23.5" fill="#7795FF" />
                    <path d="M36.8467 23.3594V39H34.7627L26.8887 26.9365V39H24.8154V23.3594H26.8887L34.7949 35.4551V23.3594H36.8467Z" fill="#F7F8FA" />
                  </svg>
                </AvatarFallback>
              </Avatar>
              <div className="flex flex-col">
                <span className="text-sm font-semibold text-[#414141] font-sora">Name Surname</span>
                <Badge variant="secondary" className="bg-[#7695ff] text-[10px] text-[#F7F8FA] dark:bg-blue-600 font-roboto w-fit">
                  Super Admin
                </Badge>
              </div>
            </div>
            <button
              onClick={() => setMobileOpen(false)}
              className="rounded-md px-3 py-1.5 text-xs font-medium text-blue-700 hover:bg-white"
            >
              Close
            </button>
          </div>
