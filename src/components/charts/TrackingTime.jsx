      ...
      <CardHeader>
         <CardTitle>
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-between">
            <span className="text-base font-semibold text-[#1F1F1F] pr-2">Tracking Time, Frequency & Focus</span>
            ...
            <div>
                 <span className="text-base font-semibold text-[#414141] text-[16px] pr-2">Daily</span>
                  <span className="text-base font-light text-[16px] font-[Roboto] text-[#414141] pr-2">/ Week</span>
            </div>
             <div>
                 <span className="text-base font-semibold text-[#414141] text-[16px] pr-2">Average Time</span>
